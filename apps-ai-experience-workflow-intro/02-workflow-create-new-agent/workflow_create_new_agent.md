...
8. Click **Cancel** to close the tool detail box:
   ...
   ![API tool Resource Path](images/tool_details_3.png " ")
...
10. Click on the **Create** button to create your agent.
   ...
   ![API tool Create](images/create_agent.png " ")
